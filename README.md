# jQuery Image Uploader Plugin

Ahmad Abdel Naser
https://www.facebook.com/sterio.tutorials
http://www.youtube.com/sterio007


in order to enable multi-file uploader you need to change the 
...
jquery.fileupload-ui.js
			...
			this plugin is ready for use , just download and use on your php wamp server , Good luck
			
			Test : 100%
			

			Other Related Stuff to the uploader :
